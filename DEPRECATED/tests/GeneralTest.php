...
class FirstTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $smMock = $this->getMock('SessionManager', ['start']);
    ...
    public function testGetAuthUrl()
    {
        ...
        $this->assertEquals('https://auth.mercadolibre.com.ar/authorization?client_id=123456&redirect_uri=http%3A%2F%2Fsomeurl.com&response_type=code', $meli->getLoginUrl(['redirect_uri' => 'http://someurl.com']));
    }
    ...
    public function testPost()
    {
        ...
        $resp = $meli->postWithAccessToken('/items', ['foo' => 'bar']);
        print_r($resp);
    ...
    public function testPut()
    {
        ...
        $resp = $meli->putWithAccessToken('/items/123', ['foo' => 'bar']);
